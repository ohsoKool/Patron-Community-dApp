      ...
      <div className="relative isolate px-6 pt-14 lg:px-8">
        ...
        >
          <div
            ...
            className="relative left-[calc(50%-11rem)] aspect-[1155/678] w-[36.125rem] -translate-x-1/2 rotate-[30deg] bg-gradient-to-tr from-[#2afff8b5] to-[#c919ff70] opacity-40 dark:opacity-20 sm:left-[calc(50%-30rem)] sm:w-[72.1875rem] custom-fade-in"
          />
        </div>
